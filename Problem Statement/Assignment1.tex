\documentclass[a4paper,10pt,onecolumn]{IEEEtran} \usepackage[margin=1.0in]{geometry} \usepackage{pdfpages} \usepackage{graphicx} 
...
%		\maketitle
	...
	\begin{minipage}{\textwidth}
		\fbox{\includegraphics[width=0.5\textwidth]{graphics/mocksize.eps}}\\
		\label{fig:fig1}
